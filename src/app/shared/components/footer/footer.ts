    ...
    <footer class="bg-sf-blue border-t border-white/5">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul class="space-y-3 text-sm">
              <li><a routerLink="/" class="text-white/75 hover:text-sf-accent-light transition-colors font-display">Home</a></li>
              <li><a routerLink="/solutions" class="text-white/75 hover:text-sf-accent-light transition-colors font-display">Solutions</a></li>
              <li><a routerLink="/about" class="text-white/75 hover:text-sf-accent-light transition-colors font-display">Company</a></li>
              <li><a routerLink="/articles" class="text-white/75 hover:text-sf-accent-light transition-colors font-display">Articles</a></li>
              <li><a routerLink="/contact" class="text-white/75 hover:text-sf-accent-light transition-colors font-display">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-3 text-sm text-white/75">
              ...
              <li><a href="mailto:info@smartfactory.ie" class="hover:text-sf-accent-light transition-colors font-mono text-sm">info&#64;smartfactory.ie</a></li>
              <li class="pt-2 flex items-center gap-4">
                <a href="https://www.linkedin.com/company/smart-factory-solutions" target="_blank" rel="noopener"
                   class="inline-flex items-center gap-2 hover:text-sf-accent-light transition-colors">
        ...
        <div class="border-t border-white/5 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <span class="text-sm text-white/75 font-mono">&copy; {{ currentYear }} SmartFactory. All rights reserved.</span>
          <div class="flex items-center gap-2">
            <span class="w-1.5 h-1.5 rounded-full bg-sf-accent"></span>
            <span class="text-sm text-white/75 font-mono">Systems operational</span>
          </div>
        </div>
      </div>
    </footer>
